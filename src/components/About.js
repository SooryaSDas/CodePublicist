...
const About = () => {
  ...
  return (
    <div>
        <div className='bg-purple-900 h-auto w-full grid grid-cols-2'>
            <div className='ml-60 pt-36 pr-7 pb-6'>
                <div className='bg-yellow-500 w-32 h-auto text-purple-800'>
                <h1 className='p-0 m-0 text-9xl'> <b>  &lt; C <br /> P &gt; </b></h1>
            <b> <p> &lt; CODE PUBLICIST &gt; </p> </b>
                </div>
            </div>
            <div className='pt-36 sm:'>
        ...
        <div className='grid grid-cols-2'>
            <div className='ml-60 pt-36 pr-7'>
                ...
                <button class="bg-purple-800 hover:bg-black text-white font-bold py-2 px-4 rounded-lg mt-3">Brochure</button>
            </div>
            <div className='ml-60 pt-36 pr-7 '>
                <ul>
                ...
                <div>
                    <div className='inline-block w-44'><p>Javascript</p></div>
                    <div className='inline-block w-44'><p>Bootstrap</p></div>
                    <div className='inline-block w-24'><p>Vue.Js</p></div>
                    <div className='inline-block w-44'><p>React.Js</p></div>
                    <div className='inline-block w-44'><p>Angular</p></div>
                    <div className='inline-block w-44'><p>Sass</p></div>
