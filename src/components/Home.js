  ...
  return (
    <div>
        <div className="grid grid-cols-2">
            <div className="pt-40 md:ml-48 lg:ml-48 sm:ml-40">
                ...
                <p className='mt-5 text-gray-400 font-mono leading-8 w-80'>
                    ...
                    <button className="mb-4 mt-5 bg-purple-800 hover:bg-black text-white font-bold py-4 px-6 border border-blue-700 rounded-lg">
                        Say Hello
                    </button>
            </div>
            <div className="pt-64 ml-32">
